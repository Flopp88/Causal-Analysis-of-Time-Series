...
if args.ground_truth is not None:
    ...
    main(datafiles, evaluation=True, path=["C:/Users/flori/Downloads/causal_discovery_for_time_series-master/causal_discovery_for_time_series-master/baselines/scripts_python"])
    ...
    ######################################
    print(args.path)
    main(datafiles, evaluation=False, path=["C:/Users/flori/Downloads/causal_discovery_for_time_series-master/causal_discovery_for_time_series-master/baselines/scripts_python"])
    ######################################
